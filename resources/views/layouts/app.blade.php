                    ...
                    <ul class="navbar-nav mr-auto">
                       <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              ...
                              <a class="dropdown-item" href="{{url("/clientes/create")}}">Crear cliente</a>
                              <a class="dropdown-item" href="{{url("/clientes")}}">Editar cliente</a>
                       ...
                       <li class="nav-item dropdown">
                         <a class="nav-link dropdown-toogle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Equipos</a>
                         <div class="dropdown-menu" aria-laballedby="navbarDropdown">
                           <a class="dropdown-item" href="{{route('equipos.index')}}">lista de equipos</a>
                           <a class="dropdown-item" href="{{route('equipos.create')}}">crear activo </a>
                           <a class="dropdown-item" href="{{route('equipos.instalar')}}">instalar equipo</a>
